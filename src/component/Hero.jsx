    ...
    return(
        <main className="pt-16 bg-hero dark:bg-hero-dark">
            <section className="h-screen flex flex-col justify-center items-center gap-7 lg:gap-4 ">
                ...
                <h1 className="w-fit text-4xl text-center dark:text-White font-bold md:text-4xl md:w-1/2 lg:w-1/3">
                    Hi,I'm a Graphic Designer.
                </h1>
                <p className="text-center dark:text-White  text-xl w-5/6 mx-auto lg:w-full">
