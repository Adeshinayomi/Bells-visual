...
export function Hero(){
    return(
        <section className="h-screen flex flex-col justify-center items-center gap-7 lg:gap-4 bg-hero lg:py-[22rem]">
            ...
            <div className="justify-self-center flex gap-3">
                ...
                <a href="#works">
                    <button className="group ease-in duration-300  flex items-center border-2 border-accent rounded-lg px-4 py-2 gap-2 hover:bg-accent hover:text-White hover:px-5">
